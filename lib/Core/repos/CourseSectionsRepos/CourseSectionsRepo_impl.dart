...
import 'package:sintir_dashboard/Core/repos/CourseSectionsRepos/CourseSectionsRepo.dart';
...
class CourseSectionsRepoImpl implements CourseSectionsRepo {
  ...
  Future<Either<Failure, void>> addCourseSection({
    ...
    try {
      ...
      return left(
        ServerFailure(
          message: "حدث خطأ أثناء إضافة القسم، يرجى المحاولة لاحقاً",
        ),
      );
    }
  }
  ...
  Future<Either<Failure, GetCourseSectionsResonseEntity>> getCourseSections({
    ...
    try {
      ...
      if (response.listData == null) {
        return left(
          ServerFailure(message: "لم يتم العثور على أقسام لهذه الدورة"),
        );
      }
      ...
      return left(
        ServerFailure(
          message: "فشل تحميل أقسام الدورة، يرجى التحقق من الاتصال",
        ),
      );
    }
  }
  ...
  Future<Either<Failure, void>> addSectionItem({
    ...
    try {
      if (sectionItem is! CourseTestEntity &&
        ...
        return left(ServerFailure(message: "نوع المحتوى غير مدعوم"));
      }
      ...
      return left(ServerFailure(message: "حدث خطأ أثناء إضافة محتوى القسم"));
    }
  }
  ...
  Future<Either<Failure, List>> getSectionsItems({
    ...
    try {
      ...
      if (data.listData == null) {
        return left(
          ServerFailure(message: "هذا القسم لا يحتوي على دروس حالياً"),
        );
      }
      ...
      return left(ServerFailure(message: "حدث خطأ أثناء تحميل محتويات القسم"));
    }
  }
  ...
  Future<Either<Failure, void>> deleteSection({
    ...
    try {
      ...
      return left(
        ServerFailure(message: "فشل حذف القسم، يرجى المحاولة مرة أخرى"),
      );
    }
  }
  ...
  Future<Either<Failure, void>> deleteSectionItem({
    ...
    try {
      ...
      return left(ServerFailure(message: "حدث خطأ أثناء محاولة حذف المحتوى"));
    }
  }
}
