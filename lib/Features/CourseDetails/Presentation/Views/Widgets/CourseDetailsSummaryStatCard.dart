...
import 'package:sintir_dashboard/Features/CourseDetails/Data/Mappers/analytics_card_mapper.dart';
...
class CourseDetailsSummaryStatCard extends StatelessWidget {
  const CourseDetailsSummaryStatCard({
    super.key,
    required this.summaryCardEntity,
  });

  final CourseDetailsSummaryCardEntity summaryCardEntity;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<
      CourseAnalyticsCubit,
      CourseAnalyticsState,
      AnalyticsCardViewModel
    >(
      selector: (state) =>
          mapCourseStateToAnalyticsCardVM(state, summaryCardEntity.type),
      builder: (context, vm) {
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            CourseDetailsSummaryStatCardFooter(
