...
import 'package:sintir_dashboard/Features/Auth/Presentation/Views/Widgets/CustomResetPasswordWidgets/CustomResetPasswordPlaceHolder.dart';
import 'package:sintir_dashboard/Features/Auth/Presentation/Views/Widgets/CustomResetPasswordWidgets/CustomResetPasswordViewBodyBlocBuilder.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Expanded(
          child:
              BlocConsumer<CustomResetPasswordCubit, CustomResetPasswordState>(
        ...
        ResetPasswordWelcomePlaceholder(),
      ],
    );
  }
}
