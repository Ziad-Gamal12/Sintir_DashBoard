...
import 'package:sintir_dashboard/Features/Support/Presentation/Views/Widgets/SupportTicketChatViewWidgets/MessageActionsBottomSheetWidgets/MessageActionsBottomSheetBody.dart';
...
class MessageActionsBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: MessageActionsBottomSheetBody(
        ticketId: ticketId,
